FROM 10.109.120.111:5000/spark-py:3.2.0-hadoop-3.2.0
...
RUN cd /opt/spark/jars \
    ...
    && wget "https://repo1.maven.org/maven2/org/apache/spark/spark-avro_2.12/3.2.0/spark-avro_2.12-3.2.0.jar" \
    && wget "https://repo1.maven.org/maven2/org/apache/kafka/kafka-clients/3.0.0/kafka-clients-3.0.0.jar" \
    && wget "https://repo1.maven.org/maven2/org/apache/spark/spark-streaming-kafka-0-10-assembly_2.12/3.2.0/spark-streaming-kafka-0-10-assembly_2.12-3.2.0.jar" \
...
# CMD python3
# tag built image as 10.109.120.111:5000/spark:3.2.0-hadoop-3.2.0-wjar
FROM localhost:32000/spark:3.1.2-hadoop-3.2.0-wjar
...
# add spark monitor to system classpath 
...
# tag built image as localhost:32000/jupyterlab-spark:3.1.2-hadoop-3.2.0-wjar